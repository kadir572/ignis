...
export const handleDownloadDocument = async (document: DocumentData, pagesInDocument: string[], thumbnailsLookup: Record<string, ThumbnailData>, documents: Record<string, DocumentData>, password?: string) => {
...
export const handleDownloadAllDocuments = async (fileName: string, pagesInDocuments: Record<string, string[]>, thumbnailsLookup: Record<string, ThumbnailData>, documents: Record<string, DocumentData>) => {
